...
using Byt3.Engine.BuildTools.PackageCreator.Versions.Legacy;
using Byt3.Engine.BuildTools.PackageCreator.Versions.v1;
using Byt3.Engine.BuildTools.PackageCreator.Versions.v2;

namespace Byt3.Engine.BuildTools.PackageCreator
{
    /// <summary>
