...
namespace Byt3.Engine.Tutorials.Tutorials
{
    public class CLScene : AbstractScene
    {
        ...
        protected override void InitializeScene()
        {
            ...
            MemoryBuffer imageBuffer = CLAPI.CreateEmpty<byte>(CLAPI.MainThread, imageSize, MemoryFlag.ReadWrite, "CLMemoryBufferForBox");
            ...
            Texture tex = TextureLoader.BytesToTexture(CLAPI.ReadBuffer<byte>(CLAPI.MainThread, imageBuffer, imageSize), 512, 512, "BoxTexture");
