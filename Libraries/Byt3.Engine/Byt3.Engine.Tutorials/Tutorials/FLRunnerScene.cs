...
namespace Byt3.Engine.Tutorials.Tutorials
{
    public class FLRunnerScene : AbstractScene
    {
        protected override void InitializeScene()
        {
            ...
            Texture tex =
                TextureLoader.ParameterToTexture(128, 128,
                    "FLRunnerScene+TexForFLRunner"); //Generating 2 Textures for our 2 boxes
            ...
            GameObject
                box = new GameObject(-Vector3.UnitZ * 4 + Vector3.UnitX, "Box"); //Creating a new Empty GameObject
            ...
            GameObject box2 =
                new GameObject(-Vector3.UnitZ * 4 - Vector3.UnitX, "Box2"); //Creating a new Empty GameObject
