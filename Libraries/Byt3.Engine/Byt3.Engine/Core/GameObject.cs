...
namespace Byt3.Engine.Core
{
    ...
    /// </summary>
    public class GameObject : ALoggable<DebugChannel>, IDestroyable
    {
        /// <summary>
        ...
        public GameObject(Vector3 localPosition, string name, GameObject parent) : base(EngineDebugConfig.Settings)
        {
