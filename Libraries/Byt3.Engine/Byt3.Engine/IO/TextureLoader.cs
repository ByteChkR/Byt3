...
namespace Byt3.Engine.IO
{
    ...
    public static class TextureLoader
    {
        ...
        public static Texture BytesToTexture(IntPtr ptr, int width, int height, object handleIdentifier)
        {
        ...
        /// <param name="height">height of the array</param>
        /// <returns>The texture</returns>
        public static Texture BytesToTexture(byte[] buffer, int width, int height, object handleIdentifier)
        {
            GCHandle handle = GCHandle.Alloc(buffer, GCHandleType.Pinned);
            Texture ret = BytesToTexture(handle.AddrOfPinnedObject(), width, height, handleIdentifier);
        ...
        /// <param name="height">height of the array</param>
        /// <returns>The texture</returns>
        public static Texture ParameterToTexture(int width, int height, object handleIdentifier)
        {
            return BytesToTexture(IntPtr.Zero, width, height, handleIdentifier);
        }
        ...
        /// <param name="bmp">Bitmap to Load</param>
        /// <returns>The GL Texture</returns>
        public static Texture BitmapToTexture(Bitmap bmp, object handleIdentifier)
        {
            bmp.RotateFlip(RotateFlipType.RotateNoneFlipY);
            BitmapData data = bmp.LockBits(new Rectangle(0, 0, bmp.Width, bmp.Height), ImageLockMode.ReadOnly,
                System.Drawing.Imaging.PixelFormat.Format32bppArgb);

            Texture tex = BytesToTexture(data.Scan0, bmp.Width, bmp.Height, handleIdentifier + "EmbeddedTexture");
        ...
        private static Texture[] AssimpSceneToTextures(Scene scene, object handleIdentifier)
        {
            ...
            {
                list.Add(AssimpEmbeddedToTexture(x, handleIdentifier));
            }
        ...
        public static Texture ColorToTexture(Color c)
        {
            ...
            bmp.SetPixel(0, 0, c);
            return BitmapToTexture(bmp, $"ColorTexture: R:{c.R} G:{c.G} B:{c.B} A:{c.A}");
        }
