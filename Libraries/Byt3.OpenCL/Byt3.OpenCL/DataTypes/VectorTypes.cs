...
sf = sF = v;
		...
		public char16(sbyte s0, sbyte s1, sbyte s2, sbyte s3, sbyte s4, sbyte s5, sbyte s6, sbyte s7, sbyte s8, sbyte s9, sbyte sa, sbyte sb, sbyte sc, sbyte sd, sbyte se, sbyte sf) 
		{
			this.s0 = s0;
this.s1 = s1;
this.s2 = s2;
...
sf = sF = v;
		...
		public uchar16(byte s0, byte s1, byte s2, byte s3, byte s4, byte s5, byte s6, byte s7, byte s8, byte s9, byte sa, byte sb, byte sc, byte sd, byte se, byte sf) 
		{
			this.s0 = s0;
this.s1 = s1;
this.s2 = s2;
