...
namespace Byt3.OpenCL.Tests
{
    ...
    public class CLSignatureAnalysisTests
    {
        ...
        public void OpenCL_KernelSignatureAnalysis_Test()
        {
            ...
            Assert.True(kernel.Parameter.ElementAt(0).Value.DataType == Wrapper.TypeEnums.DataTypes.Uchar1,
            ...
            Assert.True(kernel.Parameter.ElementAt(4).Value.DataType == Wrapper.TypeEnums.DataTypes.Uchar1,
